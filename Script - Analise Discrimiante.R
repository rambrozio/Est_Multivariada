...
## Boxplots
boxplot(x1 ~ x8, dados, main = "x1 ~ tipo de grão", xlab = 'Tipo de Grão', ylab='Area')
boxplot(x2 ~ x8, dados, main = "x2 ~ tipo de grão", xlab = 'Tipo de Grão', ylab='Perimetro')
...
################################### Função discriminante quadratica #######################################
